    ...
    },
    {
      ...
      contents: (
        <Text style={[styles.tcP, {color: theme.colors.text}]}>
          ...
          vinculante con Beyu y no es usted una persona vetada para hacer uso de
          los servicios de conformidad con la legislación de su jurisdicción
    ...
    },
    {
      ...
      contents: (
        <Text style={[styles.tcP, {color: theme.colors.text}]}>
          ...
          que incurras como resultado de descargar y usar la Aplicación de Beyu,
          incluido cualquier cargo de red de operador o itinerancia. Consulta
          con tu proveedor de servicios los detalles al respecto.
        </Text>
      ),
    },
    {
    ...
    },
    {
      ...
      contents: (
        <Text style={[styles.tcP, {color: theme.colors.text}]}>
          ...
          privacidad de Beyu y los avisos sobre privacidad de la Aplicación para
          conocer qué tipo de información recopilamos y las medidas que tomamos
